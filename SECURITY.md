...
The only network request this app makes is for the **dictionary feature** (word definitions), which sends a single word to a free dictionary API. This is optional and can be avoided by not right-clicking words.
