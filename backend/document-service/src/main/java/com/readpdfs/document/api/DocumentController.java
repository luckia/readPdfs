...
public class DocumentController {
  ...
  @PostMapping("/documents/{id}/extract-text")
  public TriggerExtractionResponse extractTextLayer(@PathVariable long id) {
    return documentService.triggerExtraction(id);
  }
