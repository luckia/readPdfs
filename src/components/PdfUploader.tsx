...
export default function PdfUploader({
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', padding: '48px' }}>
        <div style={{ width: '100%', maxWidth: '420px', textAlign: 'center' }}>
          <div style={{ marginBottom: '24px' }}><span style={{ fontSize: '48px' }}>🎧</span></div>
          <h2 className="gradient-text" style={{ fontSize: '20px', fontWeight: 700, marginBottom: '20px', letterSpacing: '-0.02em' }}>
            Loading PDF…
          </h2>
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', padding: '48px' }}>
        <div style={{ width: '100%', maxWidth: '420px', textAlign: 'center' }}>
          ...
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '8px', letterSpacing: '-0.02em' }}>Failed to Load PDF</h2>
  ...
  // ---- Default Upload ----
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', padding: '32px', backgroundColor: 'var(--bg-primary)' }}>
      <div
      ...
      >
        ...
        <h2 style={{ fontSize: '22px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '8px', letterSpacing: '-0.02em' }}>
          {isDragging ? 'Drop your PDF here!' : 'Upload a PDF'}
        </h2>

        <p style={{ fontSize: '14px', color: 'var(--text-secondary)', marginBottom: '24px', lineHeight: '1.5' }}>
          {isDragging ? 'Release to start loading…' : 'Drag & drop a PDF file here, or click to browse'}
        </p>

        {!isDragging && (
          <div className="btn-gradient" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '0 24px', height: '44px', fontSize: '14px' }}>
            <Upload size={16} />
      ...
      {/* Feature pills */}
      <div style={{ marginTop: '28px', display: 'flex', flexWrap: 'wrap', gap: '8px', justifyContent: 'center', maxWidth: '520px' }}>
        {[
